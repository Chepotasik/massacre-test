...
local menu_music_default_path = "sound/mss_mainmenu.mp3"
local menu_music_appearance_path = "sound/mss_appearencemenu.mp3"
local menu_music_flags = "noblock noplay"
local menu_music_volume = 0.75
...
local SOUND_TYPEWRITER_VOLUME = 0.75
